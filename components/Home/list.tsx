  ...
  return (
    <div>
      ...
      <div className='flex justify-center items-center'>
        {list.map((item, index) => {
          return (<div key={index} className={`flex flex-col justify-center items-center bg-[#a5a5a5] p-2 m-1 mt-6 rounded-lg grayscale hover:grayscale-0 cursor-pointer w-28 ${active == index ? 'grayscale-0 border-[1px] border-red-300' : null}`} onClick={() => isActive(index)}>
